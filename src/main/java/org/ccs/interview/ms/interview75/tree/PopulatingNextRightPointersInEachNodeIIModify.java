 ...
 * @version $Id$
 */
public class PopulatingNextRightPointersInEachNodeIIModify {
    ...
    public static void main(String[] args) {
        ...
        r.right = rr;
        rr.right=rrr;
        PopulatingNextRightPointersInEachNodeIIModify solution = new PopulatingNextRightPointersInEachNodeIIModify();
