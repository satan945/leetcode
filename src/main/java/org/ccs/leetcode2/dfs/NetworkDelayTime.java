 ...
 * impossible, return -1.
 * 
 * Note: N will be in the range [1, 100]. K will be in the range [1, N]. The length of times will be in the range [1,
 * 6000]. All edges times[i] = (u, v, w) will have 1 <= u, v <= N and 1 <= w <= 100.
 * </p>
 * 
 * @author Abel created on 2018/1/5 17:04
 * @version $Id$
 */
