 ...
 * 
 * // get hits at timestamp 301, should return 3. counter.getHits(301); Follow up: What if the number of hits per second
 * could be very large? Does your design scale?
 * </p>
 */
public class HitCounter {
    ...
    public int getHits(int timestamp) {
        while (!timeStampQueue.isEmpty() && timestamp - timeStampQueue.peek() > 300) {
            timeStampQueue.poll();
        }
    ...
    /**
     * Your HitCounter object will be instantiated and called as such: HitCounter obj = new HitCounter();
     * obj.hit(timestamp); int param_2 = obj.getHits(timestamp);
     */
}
